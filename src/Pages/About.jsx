...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Building experiences that connect and scale
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Aspiring Software Engineer proficient in Java, computer
              networking, Spring Boot, and React. Eager to leverage
              problem-solving abilities and full-stack development experience to
              build scalable applications while continuously learning and
              contributing to impactful projects.
            </p>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="https://drive.google.com/file/d/1H1hsBP3SEsPAuiAlOloNnjhqxV9_Obqb/view?usp=drive_link"
